...
angular.module('angularcmxApp')
    ...
    .controller('BookCtrl', ['$scope', '$routeParams', '$location', '$modal', 'myCache', 'GetABook', 'GetLibrary', 'bookList', function ($scope, $routeParams, $location, $modal, myCache, getABook, getLibrary, bookList) {
